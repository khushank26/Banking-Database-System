...
int QuadraticProbing::pow(int b, int p, int s)
{
...
void QuadraticProbing::merge(vector<int> &arr, int left, int mid, int right)
{
    int n1 = mid - left + 1;
    int n2 = right - mid;
...
void QuadraticProbing::mergeSort(vector<int> &arr, int left, int right)
{
    if (left < right)
    {
...
int QuadraticProbing::ord(char a)
{
    int x = a;
    return x - 55;
}
